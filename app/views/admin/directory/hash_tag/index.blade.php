...
<table class="table">
    <thead>
        <tr>
            ...
            <th>Изменен</th>
            <th style="width: 40px">
                <a href='{{ action('AdminTagController@getItem') }}'>Создать</a>
            </th>
        </tr>
    </thead>
    <tbody>
                ...
                <td>
                    <div class="dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
							<li><a href='{{ action('AdminTagController@getItem', array($i->id)) }}'>Изменить</a></li>
							<li><a href='{{ action('AdminTagController@getDelete', array($i->id)) }}'>Удалить</a></a></li>
						</ul>
					</div>
                </td>
            </tr>
