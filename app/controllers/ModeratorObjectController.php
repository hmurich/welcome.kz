<?php
class ModeratorObjectController extends AdminBaseController {
    function getIndex ($status_id = 1) {
        ...
        return View::make('moderators.object.index', $ar);
    }
    ...
    function getAddView($id){
        ...
        return View::make('moderators.object.add_view', $ar);
    }
    ...
    function postAddView($id){
        ...
        return Redirect::action('ModeratorObjectController@getIndex', 1)->with('success', 'Накрутка успешна сохранена');
    }
