...
class AdminTicketController extends AdminBaseController {
    function getIndex ($status_id) {
        ...
        return View::make('admin.ticket.index', $ar);
    }
    ...
    function getHistory($status_id, $id){
        ...
        return View::make('admin.ticket.history', $ar);
    }
    ...
    function getItem ($status_id, $id) {
        ...
        $ar['action'] = action('AdminTicketController@postItem', array($status->id, $item->id));
        $ar['item'] = $item;

        $ar['ar_topic'] = Ticket::getTopicAr();
        $ar['ar_status'] = Ticket::getStatusAr();

        return View::make('admin.ticket.item', $ar);
    }
    ...
    function postItem($status_id, $id){
        ...
        return Redirect::action('AdminTicketController@getIndex', $item->status_id)->with('success', 'Данные успешно сохранены');
    }
    ...
    function getDelete ($status_id, $id) {
        ...
        return Redirect::action('AdminTicketController@getIndex', $status->id)->with('success', 'Данные успешно удалены');
    }
}
